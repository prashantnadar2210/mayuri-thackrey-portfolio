      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <img
            ...
            height={180}
            loading="eager"
            className="mx-auto rounded-full border-4 border-sky/30 shadow-[0_0_40px_hsl(197_70%_55%/0.25)]"
          />
        </motion.div>
        <motion.h1
        ...
        >
          ...
          <span className="bg-gradient-to-r from-navy-light via-sky to-pink bg-clip-text text-transparent">
            ...
            {!done && (
              <span
                className="inline-block w-0.5 h-8 md:h-12 bg-sky ml-0.5 animate-pulse align-middle"
                aria-hidden="true"
              />
            )}
          </span>
        ...
        >
          Software Implementation Engineer — ensuring seamless implementations &
          client success.
        </motion.p>
