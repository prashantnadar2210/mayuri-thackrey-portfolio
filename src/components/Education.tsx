...
const Education = () => (
  <section id="education" aria-labelledby="edu-heading" className="py-20 px-4 bg-muted/40">
    <div className="max-w-4xl mx-auto">
      <ScrollReveal>
        <h2 id="edu-heading" className="text-3xl md:text-4xl font-bold mb-10 bg-gradient-to-r from-pink via-navy-light to-sky bg-clip-text text-transparent inline-block">
          Education
        </h2>
      </ScrollReveal>
