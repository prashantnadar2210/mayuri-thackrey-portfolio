      ...
      <div className="grid sm:grid-cols-2 gap-6">
        {edu.map((e, i) => (
          <ScrollReveal key={i} delay={i * 0.1}>
            <div className="p-6 rounded-xl bg-card border hover:shadow-[0_0_30px_hsl(330_80%_60%/0.15)] transition-shadow duration-300">
              <GraduationCap size={24} className="text-navy-light dark:text-sky mb-3" />
